...
//        System.out.println("El área del " + rectangulo.getNombre() + " es: " + rectangulo.calcularArea());
//        System.out.println("El área del " + circulo.getNombre() + " es: " + circulo.calcularArea());

        //Ejercicio Alquilando vehiculos
//        int dias = 5;
//        Vehiculo vehiculo = new Vehiculo("pepito", "menganito", 500);
//        Auto auto = new Auto("pepito", "menganito", 500);
//        Moto moto = new Moto("pepito", "menganito", 500);
//        System.out.println("El costo de alquiler del vehículo por " + dias
//                + " días es de: " + vehiculo.calcularCostoAlquiler(dias));
//        System.out.println("El costo de alquiler del auto por " + dias
