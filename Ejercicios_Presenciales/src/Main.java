...
//        System.out.println(marcador1); //color: rojo, carga: 1.0, daniado: false
        ...
        //Clase: 22/4/25
//        var p1 = new Punto(1, 1); //p1 apunta a un punto de memoria que dice que x=1 e y=1
//        var p2 = p1; //p2 apunta a la memoria de p1
//        var p3 = new Punto(1, 1); //p3 apunta a otro punto de memoria que dice que x=1 e y=1
//
//        if(p1==p2){
//            System.out.println("p1 y p2 son el mismo objeto.");
//        } if(p1.equals(p3)){
